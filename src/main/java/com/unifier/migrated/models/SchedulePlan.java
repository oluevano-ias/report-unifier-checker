...
/**
 * Represents the entire plan for executions of a ReportInstance.  Contains a collection of SchedulePlanIteration that
 * will detail
 * 1. The ReportInstance Start Date
 * 2. The ReportInstance End Date
 * 3. When to run the ReportInstance
 *
